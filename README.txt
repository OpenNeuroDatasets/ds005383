...
## Acknowledgments
This project was supported by the Academy of Medical Engineering and Translational Medicine, Tianjin University, and other affiliated institutions (as detailed in the original paper).

## References
- Bai, Y., Tang, Q., Zhao, R., et al. (2024). TMNRED: A Chinese Language EEG Dataset for Fuzzy Semantic Target Identification in Natural Reading Environments. [Journal Name], [Volume], [Pages].
